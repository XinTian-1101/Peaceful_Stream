...
import com.example.myapplication.EmergencyModule.adapter.M3_RecentConversationsAdapter;
import com.example.myapplication.Utils.AndroidUtil;
import com.example.myapplication.databinding.M3ActivityMainBinding;
...
public class M3_MainActivity extends M3_BaseActivity implements M3_ConversionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.emergency_Chat_Toolbar);
