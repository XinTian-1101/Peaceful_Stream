package com.example.myapplication.SafetyModule.M4_Helper;
...
import com.example.myapplication.SafetyModule.M4_Receiver.M4_GeofenceBroadcastReceiver;
...
public class M4_GeofenceHelper extends ContextWrapper {


    private static final String Tag = "GeofenceHelper";
    PendingIntent pendingIntent;

    public M4_GeofenceHelper(Context base) {
        super(base);
    }
    ...
    public PendingIntent getPendingIntent(){
      ...
      Intent intent = new Intent(this, M4_GeofenceBroadcastReceiver.class);
