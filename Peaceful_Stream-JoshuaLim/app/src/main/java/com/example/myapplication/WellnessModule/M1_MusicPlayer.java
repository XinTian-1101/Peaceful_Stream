...
//                toggleShuffle();
                ...
                if (isShuffle) {
                    ...
                    shuffleBtn.setColorFilter(ContextCompat.getColor(M1_MusicPlayer.this, R.color.playlist_name), PorterDuff.Mode.SRC_IN);

                } else {
                    Toast.makeText(M1_MusicPlayer.this, "Not in Shuffle", Toast.LENGTH_SHORT).show();
                    shuffleBtn.clearColorFilter();
                }
        ...
        loopBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isLoop) {
                    ...
                    loopBtn.setColorFilter(ContextCompat.getColor(M1_MusicPlayer.this, R.color.playlist_name), PorterDuff.Mode.SRC_IN);
                } else {
                    Toast.makeText(M1_MusicPlayer.this, "Not In Loop", Toast.LENGTH_SHORT).show();
                    loopBtn.clearColorFilter();
                }
