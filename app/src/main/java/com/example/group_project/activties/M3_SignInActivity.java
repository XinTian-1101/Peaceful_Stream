...
import com.example.group_project.databinding.M3ActivitySignInBinding;
import com.example.group_project.utilities.Constants;
import com.example.group_project.M3_MenuBtn;
...
public class M3_SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(preferenceManager.getBoolean(Constants.KEY_IS_SIGNED_IN)){
            Intent intent = new Intent(getApplicationContext(), M3_MenuBtn.class);
    ...
    public void openEmergencyMenu(){
        Intent intentDialing = new Intent(this, M3_MenuBtn.class);
