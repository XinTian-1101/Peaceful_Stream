...
import com.example.group_project.databinding.M3ActivitySignUpBinding;
...
public class M3_SignUpActivity extends AppCompatActivity {
    ...
    private void signUp(){
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    Intent intent = new Intent(getApplicationContext(), M3_MainActivity.class);
