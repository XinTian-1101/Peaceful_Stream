...
import com.example.group_project.databinding.M3ItemContainerUserBinding;
...
public class M3_UsersAdapter extends RecyclerView.Adapter<M3_UsersAdapter.UserViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull M3_UsersAdapter.UserViewHolder holder, int position) {
