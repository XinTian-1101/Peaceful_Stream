...
public class CounsellorDetailsPage extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener , View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(v -> {
            ...
            intent.putExtra("Counsellor Name" , counsellorName.getText().toString());
            intent.putExtra("Counsellor Position" , counsellorPosition.getText().toString());
            intent.putExtra("Counsellor Description" , counsellorDesc.getText().toString());
    ...
    public void onClick(View v) {
        ...
        String dayName = v.getResources().getResourceName(v.getId());
        if (!workingDays.contains(dayName)) {
            workingDays.add(dayBtn.getText().toString());
