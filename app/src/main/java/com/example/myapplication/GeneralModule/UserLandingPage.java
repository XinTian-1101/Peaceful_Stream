...
import com.example.myapplication.EmergencyModule.activties.M3_SignInActivity;
...
public class UserLandingPage extends AppCompatActivity implements ModulesRecViewAdapter.OnModuleListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Module("https://firebasestorage.googleapis.com/v0/b/mad-assignment-cb1c0.appspot.com/o/NormalUser_Counseling.png?alt=media&token=cdcc1229-449a-4e2f-8f6d-e8d4dccb836c" , "Communication and\nConsultation Module" , "#C8DDED"));
