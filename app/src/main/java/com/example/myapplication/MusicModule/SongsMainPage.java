    ...
    public void initiateCustomPlayerAndBottomSheet (Context context , View includedCustomPlayer , int position , List<Song> songList ,
        ...
        repeatBtmSheet.setOnClickListener(view -> {
            if (repeatMode[0] == 0) {
                ...
                repeatMode[0] = 1;
                repeatBtmSheet.setImageResource(R.drawable.ic_repeat_on_white);
            }
            else if (repeatMode[0] == 1) {
                player.setRepeatMode(Player.REPEAT_MODE_ALL);
                repeatMode[0] = 2;
                repeatBtmSheet.setImageResource(R.drawable.ic_repeat_one_on_white);
            }
            else {
                player.setRepeatMode(Player.REPEAT_MODE_OFF);
                repeatMode[0] = 0;
                repeatBtmSheet.setImageResource(R.drawable.ic_repeat_white);
            }
        });
