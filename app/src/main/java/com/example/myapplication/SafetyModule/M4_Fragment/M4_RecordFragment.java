...
import com.example.myapplication.SafetyModule.M4_Service.M4_RecordingService;
import com.example.myapplication.R;
import com.example.myapplication.databinding.M4FragmentRecordBinding;

import java.io.File;


public class M4_RecordFragment extends Fragment {

    // Binding object instance with access to the views in the fragment_record.xml layout
    private M4FragmentRecordBinding binding;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recordingServiceIntent = new Intent(getActivity(), M4_RecordingService.class);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = M4FragmentRecordBinding.inflate(inflater, container, false);
    ...
    private void startRecording() {
            ...
            binding.recordBtn.setImageResource(R.drawable.m4_ic_media_stop);
    ...
    private void stopRecording() {
        binding.recordBtn.setImageResource(R.drawable.m4_ic_mic);
