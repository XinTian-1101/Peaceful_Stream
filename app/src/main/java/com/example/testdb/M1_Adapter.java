...
public class M1_Adapter extends RecyclerView.Adapter<M1_Adapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public M1_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull M1_Adapter.MyViewHolder holder, int position) {
