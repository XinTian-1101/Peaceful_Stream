...
public class M1_SongAdapter extends RecyclerView.Adapter<M1_SongAdapter.MyViewHolder>{
    ...
    @NonNull
    @Override
    public M1_SongAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull M1_SongAdapter.MyViewHolder holder, int position) {
